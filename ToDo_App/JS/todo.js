...
var dog1 = '{"name":"Dax", "breed":"Great Pyrenees", "color":"White"}';

var JSONparse = JSON.parse(dog1);
document.getElementById("parse").innerHTML = JSONparse.name + " the " + JSONparse.breed;
